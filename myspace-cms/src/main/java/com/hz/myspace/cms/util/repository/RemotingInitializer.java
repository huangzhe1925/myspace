...
package com.hz.myspace.cms.util.repository;
...
public class RemotingInitializer {
    ...
    @Value("${ms.cms.repository.home}/dav")
    ...
    public ServletRegistrationBean<SimpleWebdavServlet> webDavServlet() {
        ...
        bean.addInitParameter(SimpleWebdavServlet.INIT_PARAM_RESOURCE_CONFIG, "/config/remoting/webdav-config.xml");
        return bean;
    }
    ...
    public ServletRegistrationBean<JcrRemotingServlet> remotingServlet() {
        ...
        bean.addInitParameter(JcrRemotingServlet.INIT_PARAM_BATCHREAD_CONFIG, "/config/remoting/batchread.properties");

        bean.addInitParameter(JcrRemotingServlet.INIT_PARAM_PROTECTED_HANDLERS_CONFIG,
                "/config/remoting/protectedHandlersConfig.xml");
